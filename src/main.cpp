...
unsigned int nStakeMaxAge = 48 * 60 * 60; // 48 hours
...
const string strMessageMagic = "DustCoin Signed Message:\n";

// Settings
int64_t nTransactionFee = GetTxFee();
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DustCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "donderdag 17 december 2015 526978c5-0185-4997-8adb-c721a6fc90d7";
        CTransaction txNew;
        txNew.nTime = 1450386607;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime = 1450386607;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce = 1338326 ;
		if(fTestNet)
        {
            block.nNonce = 1338326 ;
        }
		
		uint256 nhashMerkleRoot = uint256("0xbeff7d4e893f6877a87871c8157e4da2a17e6149bb96956da9a0267bf692c2a6");
